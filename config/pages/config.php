  ...
  <div id="email-block" class="panel-collapse collapse">
   ...
   <div id="email_group" class="form-group ">
	...
	<div class="form-group">
		...
		<span class="help-block">Текст письма, который будет добавлен к оповещению о покупателе. Может содержать дополнительные переменные.<br><strong>Инструкция в документации <a href="https://config-v2.github.io/#eml" target="_blank">setlp.com</a></strong></span>
</div></div>
<div class="form-group">
