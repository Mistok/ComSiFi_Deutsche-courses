...
<html lang="en">
 <head>
  ...
  <meta name="author" content="by SetLP.com" />
    <meta name="copyright" content="https://setlp.com" />
    ...
    <div class="navbar-collapse collapse">
     ...
     <ul class="nav navbar-nav navbar-right">
      ...
      <li ><a data-toggle="modal" data-target="#pass" href="<?php echo  $config['menu_link']['pass'] ?>"><?php echo  $config['menu_name']['pass'] ?></a></li>
	    <li ><a data-toggle="modal" data-target="#clear" href="<?php echo  $config['menu_link']['clear'] ?>"><?php echo  $config['menu_name']['clear'] ?></a></li>
      <li <?php  if ($_GET['page']=="help") echo('class="active"'); ?>><a  href="<?php echo  $config['menu_link']['help'] ?>"><?php echo  $config['menu_name']['help'] ?></a></li>
		<li> <a href="<?php echo  $config['menu_link']['don'] ?>" ><?php echo  $config['menu_name']['don'] ?></a></li>
...
<?php  if ($password==md5('admin')) { ?>
 ...
 <a href="#" class="alert-link "><strong>Внимание!</strong> В целях безопасности поменяйте пароль для входа в админ-панель <?php echo  $config['name'] ?></a>
</div>
<?php  } ?>
...
<div class="navbar navbar-default navbar-fixed-bottom footer" role="navigation">
   <div class="container">
     ...
     <a class="navbar-brand footer" href="<?php echo  $config['site_conf'] ?>">&copy; 2017-<?php echo  date("Y")?> <?php echo  $config['name'] ?> с админкой v.<?php echo  $config['ver']?></a>
